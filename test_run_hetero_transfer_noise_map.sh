...
args="--env multi_robot_pb --num_robots 2  --cur_succ 0   --gap_avoidance --epochs 8400 
--max_ep_len 100 --local_epoch_len 250  --insert_wall --exp Saved_models/Spot_Titan/selected/
--folder 2025_06_06_12_53_34 --reward_fn 32      --occupancy_map --use_perception  
