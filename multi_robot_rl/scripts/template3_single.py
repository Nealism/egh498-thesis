...
class RLRobot():
    ...
    def occupancy_callbacklocal(self, msg6:OccupancyGrid):
        ...
        self.scaled_map = np.where(map_data == 100, 1, 0)
...
if __name__ == "__main__":
    ...
    mu_net = torch.load("/refarm/src/multi_robot_rl/scripts/JIT_models/turtle_titan/mu_net.jit")
    z_net = torch.load("/refarm/src/multi_robot_rl/scripts/JIT_models/turtle_titan/z_net.jit")
