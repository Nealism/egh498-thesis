...
if __name__ == "__main__":
    ...
    mu_net = torch.load("/refarm/src/multi_robot_rl/scripts/JIT_models/FC/mu_net_s.jit")
    z_net = torch.load("/refarm/src/multi_robot_rl/scripts/JIT_models/FC/z_net_s.jit")
    ...
    while not rospy.is_shutdown():
        ...
        if R1.robot_pose is not None and R1.robot_vel is not None and R1.goal_pos is not None and R1.im is not None:
            joint_observation=[R1.get_observation()]
            joint_map=[R1.get_occupancy_image()]
        ...
        # # output_dir ="/home/kom018/behaviour_rl/Results_plots/Action_plots"
        if R1.current_sim_time.to_sec()>7:
            output_dir ="/refarm/src/multi_robot_rl/scripts/plots/exp_s1"
            ...
            output_video = '/refarm/src/multi_robot_rl/scripts/plots/exp_s1/r1_map_s1.mp4'
