...
def get_defaults():
    ...
    parser.add_argument('--obstacle', default=False, action="store_true")
    ...
    parser.add_argument('--experiment_0', default=False, action="store_true")
    ...
    parser.add_argument('--cloning', default=False, action="store_true")
    parser.add_argument('--Dagger', default=False, action="store_true")
...
def get_env(args):
    ...
    if args.env == "humanoid_pb":
        ...
        from assets.env_titan_pb_4_dt_speed import Env
        args.control_type = "velocity"
