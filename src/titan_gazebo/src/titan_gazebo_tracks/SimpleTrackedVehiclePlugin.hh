...
namespace gazebo {
    ...
    public TrackedVehiclePlugin
  {
    ...
    protected: std::unordered_map<Tracks, double> desiredTrackVelocity;

    /// \brief Current velocities of the tracks.
    protected: std::unordered_map<Tracks, double> currentTrackVelocity;

    /// \brief acceleration limit per loop of the tracks
    protected: double trackAccelPerLoop;

    /// \brief physics step size
    protected: double physicsStepSize;
