...
declare -a Arguments=(
    ...
    # "--cpu 64 --env multi_robot_pb --reward_fn 27 --cur_succ 7  --training_on_hpc --gap_avoidance --epochs 7000 --max_ep_len 3500 --local_epoch_len 7000 --expert_curr --gap_curr"
     "--cpu 64 --env multi_robot_pb --reward_fn 28 --cur_succ 6  --training_on_hpc --gap_avoidance --epochs 7000 --max_ep_len 3500 --local_epoch_len 7000 --expert_curr --gap_curr"
    ...
    # "--cpu 64 --env multi_robot_pb --reward_fn 27 --cur_succ 7  --training_on_hpc --gap_avoidance --epochs 7000 --max_ep_len 3500 --local_epoch_len 7000 --expert_curr --gap_curr --gap_decrease 0.1"
     "--cpu 64 --env multi_robot_pb --reward_fn 28 --cur_succ 6  --training_on_hpc --gap_avoidance --epochs 7000 --max_ep_len 3500 --local_epoch_len 7000 --expert_curr --gap_curr --gap_decrease 0.1"
    # "--cpu 64 --env multi_robot_pb --reward_fn 29 --cur_succ 6  --training_on_hpc --gap_avoidance --epochs 7000 --max_ep_len 3500 --local_epoch_len 7000 --expert_curr --gap_curr --gap_decrease 0.1"
     "--cpu 64 --env multi_robot_pb --reward_fn 30 --cur_succ 6  --training_on_hpc --gap_avoidance --epochs 7000 --max_ep_len 3500 --local_epoch_len 7000 --expert_curr --gap_curr --gap_decrease 0.1"
    ...
    "--cpu 64 --env multi_robot_pb --reward_fn 28 --cur_succ 6  --training_on_hpc --gap_avoidance --epochs 7000 --max_ep_len 3500 --local_epoch_len 7000 --expert_curr --gap_curr --gap_decrease 0.25"
    ...
    # "--cpu 64 --env multi_robot_pb --reward_fn 27 --cur_succ 7  --training_on_hpc --gap_avoidance --epochs 7000 --max_ep_len 3500 --local_epoch_len 7000 --expert_curr"
     "--cpu 64 --env multi_robot_pb --reward_fn 28 --cur_succ 6  --training_on_hpc --gap_avoidance --epochs 7000 --max_ep_len 3500 --local_epoch_len 7000 --expert_curr"
