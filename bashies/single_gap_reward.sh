...
declare -a Arguments=(
    ...
    "--cpu 64 --env multi_robot_pb --reward_fn 28 --cur_succ 6  --training_on_hpc --gap_avoidance --epochs 7000 --max_ep_len 3500 --local_epoch_len 3500 --expert_curr --detect_distance 2 --insert_wall --gap_curr"
    "--cpu 64 --env multi_robot_pb --reward_fn 2 --cur_succ 6  --training_on_hpc --gap_avoidance --epochs 7000 --max_ep_len 3500 --local_epoch_len 3500 --expert_curr --detect_distance 2 --insert_wall --gap_curr"

    "--cpu 64 --env multi_robot_pb --reward_fn 28 --cur_succ 6  --training_on_hpc --gap_avoidance --epochs 7000 --max_ep_len 3500 --local_epoch_len 3500 --expert_curr --detect_distance 2 --insert_wall --gap_curr --gap_decrease 0.1"
    "--cpu 64 --env multi_robot_pb --reward_fn 2 --cur_succ 6  --training_on_hpc --gap_avoidance --epochs 7000 --max_ep_len 3500 --local_epoch_len 3500 --expert_curr --detect_distance 2 --insert_wall --gap_curr --gap_decrease 0.1"
    
    "--cpu 64 --env multi_robot_pb --reward_fn 28 --cur_succ 6  --training_on_hpc --gap_avoidance --epochs 7000 --max_ep_len 3500 --local_epoch_len 3500 --expert_curr --detect_distance 2 --insert_wall --gap_curr --gap_decrease 0.25"
    "--cpu 64 --env multi_robot_pb --reward_fn 2 --cur_succ 6  --training_on_hpc --gap_avoidance --epochs 7000 --max_ep_len 3500 --local_epoch_len 3500 --expert_curr --detect_distance 2 --insert_wall --gap_curr --gap_decrease 0.25"

    "--cpu 64 --env multi_robot_pb --reward_fn 28 --cur_succ 6  --training_on_hpc --gap_avoidance --epochs 7000 --max_ep_len 3500 --local_epoch_len 3500 --expert_curr --detect_distance 2 --insert_wall"
    "--cpu 64 --env multi_robot_pb --reward_fn 2 --cur_succ 6  --training_on_hpc --gap_avoidance --epochs 7000 --max_ep_len 3500 --local_epoch_len 3500 --expert_curr --detect_distance 2 --insert_wall"
