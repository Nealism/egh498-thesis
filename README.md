...
- Create save directory to mirror what happens on the HPC, this is where results are saved locally:
    - first time: `sudo mkdir -p /scratch1/<ident>/results` <br/>
- Copy code to HPC: <br/>
...
- setup environment on the HPC (for the first time, or when you need to add a package):
    ...
    - Install anything you need
        -  e.g `pip3 install requirements.txt`
    - Installing mujoco:
        - 
- Useful commands:<br/>
`squeue -u <ident>`<br/>
...
- Run bash script of commands: <br/>
    ...
    - If you have mounted the to hpc-home, you can look at the training logs under `/home/<ident>/hpc-home/behaviour_rl/bashies`
...
- Tensorboard and live progress updates
    - Provided you have mounted `hpc-scratch` you can view tensorboard plots:
        - Run:
        -  `tensorboard --logdir=/home/<ident>/hpc-scratch/results/experiment_folder`
