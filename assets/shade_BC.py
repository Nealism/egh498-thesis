...
def main():
    ...
    directories = ['/home/kom018/titan_results_data_tensorboard/accuracy/boot_Gap/', '/home/kom018/titan_results_data_tensorboard/accuracy/Gap_only/', '/home/kom018/titan_results_data_tensorboard/accuracy/End_to_End/','/home/kom018/titan_results_data_tensorboard/Dagger/Gap_cur/','/home/kom018/titan_results_data_tensorboard/accuracy/Boot_Random_Gap/']
    labels = ['MA_Bootstrap+Gap Cur', 'Gap Cur Only', 'End-to-End Learning','Dagger+Gap_Cur','MA_Bootstrap+Random_Gap']
    colors = ['green', 'blue', 'red','orange','brown']  # darkorange for dark yellow
