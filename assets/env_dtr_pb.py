...
class Env(EnvBasePB):
    ...
    def load_specific_robot(self):
        ...
        if "pumpkin" in self.args.env:
            ...
            if self.args.turtle_titan:
                robot1=self.load_urdf_robot("./assets/urdfs/turtlebot_DTR.urdf")
            else:
    ...
    def twist_to_tracks(self, actions):
        # print(actions)
        # if self.args.turtle_titan or (self.args.turtle_titan and self.args.titan_speed): 
        #     radius = 0.14
        #     width = 0.78/2
        #     # print(actions)
        ...
        if self.args.turtle_titan: 
            ...
            # print(actions)
            lin_vel = actions[0]*3.9#*0.50
            ang_vel = np.clip(actions[1], -1.0, 1.0) #*0.48#*2.5/2
            # print(lin_vel,np.clip(ang_vel, -0.65, 0.65))
            # ang_vel = actions[1] #*3/2
            w_r = (lin_vel + ang_vel*width)/radius
            w_l = (lin_vel - ang_vel*width)/radius
    ...
    def motor_action(self,actions):
        ...
        clipped_angular_vel_command=np.clip(self.applied_actions[1], -1.0, 1.0)
