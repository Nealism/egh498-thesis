...
# Function to visualize the maps using OpenCV
def visualize_maps(global_map, local_heightmap, local_heightmap_position, turtlebot_position):
...
while (1):
    ...
    visualize_maps(global_map, local_heightmap, local_heightmap_position, robot_position)
