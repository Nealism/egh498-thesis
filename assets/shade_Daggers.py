...
def plot_performance(epochs_list, means_list, stds_list, labels, colors):
    ...
    plt.tight_layout()
    plt.savefig('Daggers_Only.png')  # Save the plot as a PNG file
    plt.show()

def main():
    # Directories containing CSV files for each method
    directories = ['/home/kom018/titan_results_data_tensorboard/Dagger/2_0.85/', '/home/kom018/titan_results_data_tensorboard/Dagger/Random_Gap/', '/home/kom018/titan_results_data_tensorboard/Dagger/Gap_cur/']
    labels = ['Dagger_0.85', 'Dagger+Random_GAP','Dagger+GapCur']
    colors = ['orange', 'blue', 'green']  # darkorange for dark yellow
