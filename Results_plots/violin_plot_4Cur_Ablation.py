...
data1 = pd.read_csv("/home/kom018/behaviour_rl/Results_plots/pybullet_excels/Regular_Reward.csv")["value"]
data2 = pd.read_csv("/home/kom018/behaviour_rl/Results_plots/pybullet_excels/Regular_Reward_R2.csv")["value"]
data3 = pd.read_csv("/home/kom018/behaviour_rl/Results_plots/pybullet_excels/MA_Boot_only.csv")["value"]
data4 = pd.read_csv("/home/kom018/behaviour_rl/Results_plots/pybullet_excels/MA_Boot_only_R2.csv")["value"]
...
ax.legend(handles=legend_patches, loc='upper right',fontsize=30)

plt.tight_layout()

# Save the figure
plt.savefig('/home/kom018/behaviour_rl/Results_plots/pybullet_excels/Training_Curriculum_Ablation_studies.png')
