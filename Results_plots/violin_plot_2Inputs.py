...
data3 = pd.read_csv("/home/kom018/behaviour_rl/Results_plots/pybullet_excels/Without_other_robot_info.csv")["value"]
data4 = pd.read_csv("/home/kom018/behaviour_rl/Results_plots/pybullet_excels/Without_other_robot_info_R2.csv")["value"]
...
experiments = {
    "Using Other Robot Information": sorted(data1),
    " ": sorted(data2),
    "Without Using Other Robot Information": sorted(data3),
    "": sorted(data4)
}
...
# Save the figure
plt.savefig('/home/kom018/behaviour_rl/Results_plots/pybullet_excels/Training_different_Inputs.png')
